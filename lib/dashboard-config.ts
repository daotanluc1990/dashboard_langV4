...
export const tabs: Array<{ id: TabId; label: string; short: string; icon: string }> = [
  ...
  { id: 'cost', label: 'Action Center', short: 'Action', icon: 'ReceiptText' },
  { id: 'pnl', label: 'Lợi nhuận & P&L', short: 'P&L', icon: 'BadgeDollarSign' },
  { id: 'operations', label: 'Chi nhánh', short: 'Chi nhánh', icon: 'Settings' },
...
export const tabTitles: Record<TabId, { title: string; subtitle: string }> = {
  ...
  cost: { title: 'Action Center', subtitle: 'Việc cần xử lý hôm nay, tác động tài chính, owner và hành động tiếp theo.' },
  ...
  operations: { title: 'Chi nhánh', subtitle: 'Chi nhánh nào nên đầu tư, chi nhánh nào cần can thiệp, điểm nào kéo lùi chuỗi.' },
