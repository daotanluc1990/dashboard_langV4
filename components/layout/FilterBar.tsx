  ...
  return (
    <section className="filters">
      <div className="filter-grid">
        ...
        <div className="f"><label>Kênh</label><select value={filters.channel} onChange={e=>set({channel:e.target.value})}><option value="all">Tất cả kênh</option><option>Tiền mặt</option><option>Chuyển khoản</option><option>Grab</option><option>Shopee</option><option>Be</option><option>Xanh ngon</option><option>Takeaway</option></select></div>
